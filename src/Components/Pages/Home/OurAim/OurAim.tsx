...
import aimImg from '../../../../../public/img/aim section.jpg';
import aimImgTwo from '../../../../../public/img/aim section img 2.jpg';
        ...
        <div className=" pt-32">
            <div className="grid lg:grid-cols-2 justify-center flex-col gap-16 max-w-[1240px] mx-auto px-5">
                <div className='relative'>
                    <Image src={aimImg} className="w-[100%]" alt='' />
                    <Image className="absolute bottom-[-9%] left-[52%] w-[55%] border-l-[16px] border-t-[16px] border-white " src={aimImgTwo} alt="" />
                </div>
