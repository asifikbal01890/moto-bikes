...
export default function TopSeller() {
    ...
    return (
        <div className=' my-16 lg:my-0 lg:mt-32 max-w-[1290px] mx-auto px-5 text-center'>
            ...
            <div className='mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 text-start'>
                {
                    sellersInfo.map((info, i) =>
                        <div key={i} className='flex gap-5 bg-slate-100 p-4'>
                            {/* <Image className='rounded-full' src={info.photo} alt="" /> */}
