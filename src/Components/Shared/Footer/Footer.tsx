...
export default function Footer() {
    return (
        <footer className="bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100 mt-16">
            <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                    <Link href="/" className="normal-case text-xl font-bold text-white"><span className='text-primary uppercase'>Moto</span>Bikes</Link>
